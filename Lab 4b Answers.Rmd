...
```
    ...
    ##3 out of 50 intervals do not fall under the true mean or 94% of the intelvals are within true mean. The proportion is not eqal to the confidence interval, the reason could be due to the fact that the distribution is not normal

-   Pick a confidence level of your choosing, provided it is not 95%. What is 
    the appropriate critical value?
    
    ##I will select 98% confidence level which has the critical value of 2.33.  
...
```
    ...
    ##49 out of 50 intervals fall under the true mean, which is 98%. That is equal to the confidence interval
