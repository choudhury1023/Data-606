...
hist(sample_means50, breaks = 25)
```
##The shape of this sampling distribution is symmetrical.

##Based on the sampling distribution I would guess the mean to be around 180000

```{r population_mean1, eval=TRUE}
mean(price)
```
...
```    
##Also symmetrical with smaller spread

##I would guess the mean to be around 180000
...
-   Of the sampling distributions from 2 and 3, which has a smaller spread?  If
    ...
    ##The bigger sample(150) has a smaller spread than the smaller sample(50). A     smaller spread the smaple are closer to the center and gives better idea         about true value and id preferable.
